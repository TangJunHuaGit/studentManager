...
CREATE TABLE `class`  (
  ...
  `state` int(11) NULL DEFAULT NULL COMMENT '1为正常，2为注销',
...
-- Records of teacher
-- ----------------------------
INSERT INTO `teacher` VALUES (1, '袁老师', '15672342314', '2021-01-19', 1, 3, 1, '1', '2021-01-19 10:52:14', 1);
...
-- ----------------------------
INSERT INTO `teacher_user` VALUES (1, 21, 1);
