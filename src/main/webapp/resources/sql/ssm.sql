...
CREATE TABLE `class`  (
  ...
  `Sate` int(11) NULL DEFAULT NULL COMMENT '1为正常，2为注销',
...
INSERT INTO `sys_function` VALUES (98, 9, 'permission', 0, 'loadOneTeacherByClassId', '根据班级查询教师', NULL, '../teacher/loadOneTeacherByClassId.action', NULL, NULL, NULL, 1, NULL, '2021-01-19 11:19:26', NULL);
INSERT INTO `sys_function` VALUES (99, 8, 'permission', 0, 'updateStudentStateByStudentId', '审批权限', NULL, '../student/updateStudentStateByStudentId.action', NULL, NULL, NULL, 1, NULL, '2021-01-19 14:54:34', NULL);
